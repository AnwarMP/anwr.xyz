...
import photo1 from "public/gallery/lavender_farm.png"; // Update with your image names
import photo2 from "public/gallery/sausalito.png";
import photo3 from "public/gallery/hackathon.png";
import photo4 from "public/gallery/sf.png";
...
export default function Gallery() {
  return (
    <section className="flex gap-4 h-[268px] relative mt-6 mb-12">
      <Photo
        src={photo1}
        meta="2024"
